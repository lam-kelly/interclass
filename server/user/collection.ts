...
class UserCollection {
   ...
   */
  static async addOne(username: string, password: string, role: string): Promise<HydratedDocument<User>> {
    const dateJoined = new Date();

    const user = new UserModel({username, password, dateJoined, role});
